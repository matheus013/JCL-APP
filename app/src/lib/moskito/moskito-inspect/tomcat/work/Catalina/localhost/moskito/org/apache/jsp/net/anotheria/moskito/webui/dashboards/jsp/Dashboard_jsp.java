 ...
 * Generated at: 2018-07-10 13:36:55 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.net.anotheria.moskito.webui.dashboards.jsp;
...
public final class Dashboard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /net/anotheria/moskito/webui/dashboards/jsp/Dashboard.jsp(25,8) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_ano_005fiterate_005f0.setName("widgets");
        // /net/anotheria/moskito/webui/dashboards/jsp/Dashboard.jsp(25,8) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_ano_005fiterate_005f0.setId("widget");
        // /net/anotheria/moskito/webui/dashboards/jsp/Dashboard.jsp(25,8) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_ano_005fiterate_005f0.setType("net.anotheria.moskito.core.config.dashboards.DashboardWidget");
        ...
        if (_jspx_eval_ano_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          net.anotheria.moskito.core.config.dashboards.DashboardWidget widget = null;
          ...
          widget = (net.anotheria.moskito.core.config.dashboards.DashboardWidget) _jspx_page_context.findAttribute("widget");
          do {
            out.write("\n");
            out.write("             ");
            org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, (java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${widget.jspPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null), out, false);
            out.write("\n");
            out.write("        ");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"modal fade\" id=\"CreateDashboard\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\" style=\"display: none;\">\n");
      out.write("    <div class=\"modal-dialog modal-sm\">\n");
      out.write("        <div class=\"modal-content\">\n");
      out.write("            <div class=\"modal-header\">\n");
      out.write("                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n");
      out.write("                <h4 class=\"modal-title\">Create Dashboard</h4>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"modal-body\">\n");
      out.write("                <label>Please type new Dashboard name</label>\n");
      out.write("                <form name=\"CreateDashboard\" action=\"mskCreateDashboard\" method=\"GET\">\n");
      ...
      out.write("                        <input type=\"text\" class=\"form-control\" name=\"pName\" placeholder=\"Name\">\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"form-group text-center\">\n");
      out.write("                        <button class=\"btn btn-success\" type=\"button\" onclick=\"submit();\">Create</button>\n");
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("<div class=\"modal fade modal-danger\" id=\"DeleteDashboard\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\" style=\"display: none;\">\n");
      out.write("    <div class=\"modal-dialog modal-sm\">\n");
      out.write("        <div class=\"modal-content\">\n");
      out.write("            <div class=\"modal-header\">\n");
      out.write("                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n");
      out.write("                <h4 class=\"modal-title\">Delete Dashboard \"");
      ...
      out.write("                <form name=\"CreateDashboard\" action=\"mskDeleteDashboard\" method=\"GET\">\n");
      out.write("                    <input type=\"hidden\" name=\"remoteConnection\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${remoteLink}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/>\n");
      ...
      out.write("                        <button class=\"btn btn-default\" type=\"button\" data-dismiss=\"modal\">Cancel</button>\n");
      out.write("                        <button class=\"btn btn-danger\" type=\"button\" onclick=\"submit();\">Delete</button>\n");
      out.write("                    </div>\n");
      out.write("                </form>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      ...
      out.write("    (function (dashboard, $) {\n");
      out.write("        dashboard.restApiUrl = '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dashboardRestApiUrl}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("';\n");
      out.write("        dashboard.refreshInterval = ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dashboardRefreshRate}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(";\n");
      out.write("\n");
      out.write("        dashboard.init = function () {\n");
      out.write("            setTimeout(function () {\n");
      out.write("                getDashboardData();\n");
      out.write("            }, dashboard.refreshInterval)\n");
      out.write("        };\n");
      out.write("\n");
      out.write("        function getDashboardData() {\n");
      out.write("            var success = function (response) {\n");
      out.write("                if(response.success != true) {\n");
      out.write("                    console.info(\"Not successful response.\");\n");
      out.write("                    return;\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                var dashboard = response[\"results\"][\"dashboard\"];\n");
      out.write("\n");
      out.write("                refreshThresholdStatuses(dashboard[\"thresholds\"]);\n");
      out.write("                refreshGaugeCharts(dashboard[\"gauges\"]);\n");
      out.write("                refreshLineCharts(dashboard[\"charts\"]);\n");
      out.write("            };\n");
      out.write("\n");
      out.write("            $.ajax({\n");
      out.write("                url: dashboard.restApiUrl,\n");
      out.write("                type: \"GET\",\n");
      out.write("                headers: {\n");
      ...
      out.write("                    console.info(\"Unable to refresh dashboard.\");\n");
      out.write("                },\n");
      ...
      out.write("        }\n");
      out.write("\n");
      out.write("        function refreshThresholdStatuses(thresholdStatuses) {\n");
      out.write("            _.each(thresholdStatuses, function (thresholdStatus, idx) {\n");
      out.write("                var name = thresholdStatus[\"name\"],\n");
      out.write("                        value = thresholdStatus[\"value\"],\n");
      out.write("                        colorCode = thresholdStatus[\"colorCode\"];\n");
      out.write("\n");
      out.write("                var $thresholdItem = $('.threshold-item').eq(idx);\n");
      out.write("                $thresholdItem.find(\".threshold-title\").text(name + \" \" + value);\n");
      out.write("                $thresholdItem.find(\"i.status\").attr(\"class\", \"status status-\" + colorCode);\n");
      out.write("            });\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        function refreshGaugeCharts(gauges) {\n");
      out.write("            _.each(gauges, function (gauge, idx) {\n");
      out.write("                chartEngineIniter.d3charts.dispatch.refreshGauge({\n");
      out.write("                    \"containerId\": \"#gaugeChart\" + idx,\n");
      out.write("                    \"min\": Number(gauge[\"min\"]),\n");
      out.write("                    \"max\": Number(gauge[\"max\"]),\n");
      out.write("                    \"current\": Number(gauge[\"current\"])\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        function refreshLineCharts(dashboardCharts) {\n");
      out.write("            _.each(dashboardCharts, function (dashboardChart, idx) {\n");
      out.write("                var multiLineChart = dashboardChart[\"chart\"];\n");
      out.write("\n");
      out.write("                var names;\n");
      out.write("                if (_.isArray(multiLineChart[\"names\"])) {\n");
      out.write("                    names = _.map(multiLineChart[\"names\"], function (name) {\n");
      out.write("                        return name;\n");
      out.write("                    });\n");
      out.write("                } else {\n");
      out.write("                    names = [].concat(multiLineChart[\"names\"]);\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                var data = _.map(multiLineChart[\"data\"], function (accumulatedValueObj) {\n");
      out.write("                    var dataItem = [];\n");
      out.write("\n");
      out.write("                    dataItem.push(_.toNumber(accumulatedValueObj[\"numericTimestamp\"]));\n");
      out.write("\n");
      out.write("                    _.each(accumulatedValueObj[\"values\"], function (valueItem) {\n");
      out.write("                        dataItem.push(_.toNumber(valueItem));\n");
      out.write("                    });\n");
      out.write("\n");
      out.write("                    return dataItem;\n");
      out.write("                });\n");
      out.write("\n");
      out.write("                var containerId = \"#chart_div\" + idx;\n");
      out.write("                var colors = [];\n");
      out.write("\n");
      out.write("                if (!isEmptyObject(thresholdsGraph[idx])) {\n");
      out.write("                    addThresholdsToChart(thresholdsGraph[idx], {\"data\": data, \"names\": names, \"colors\": colors});\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                chartEngineIniter.d3charts.dispatch.refreshLineCharts({\n");
      out.write("                    \"containerId\": containerId,\n");
      out.write("                    \"data\": data,\n");
      ...
      out.write("            });\n");
      out.write("        }\n");
      out.write("    }(window.dashboard = window.dashboard || {}, jQuery));\n");
      out.write("\n");
      out.write("\n");
      out.write("    $(function () {\n");
      ...
      out.write("</script>\n");
      out.write("\n");
      out.write("<script src=\"../moskito/int/js/dashboard.js\" type=\"text/javascript\"></script>\n");
      out.write("\n");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/net/anotheria/moskito/webui/shared/jsp/ChartEngine.jsp", out, false);
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/net/anotheria/moskito/webui/producers/jsp/snippet/ProducerHelpModal.jsp", out, false);
      out.write("\n");
      out.write("</body>\n");
      out.write("</html>\n");
      out.write("\n");
  ...
  private boolean _jspx_meth_ano_005fequal_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /net/anotheria/moskito/webui/dashboards/jsp/Dashboard.jsp(10,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_ano_005fequal_005f0.setName("showHelp");
      // /net/anotheria/moskito/webui/dashboards/jsp/Dashboard.jsp(10,4) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ano_005fpresent_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /net/anotheria/moskito/webui/dashboards/jsp/Dashboard.jsp(17,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_ano_005fpresent_005f0.setName("infoMessage");
      ...
      if (_jspx_eval_ano_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("            <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>\n");
          out.write("            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.infoMessage}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("\n");
          out.write("        </div>\n");
          out.write("    ");
  ...
  private boolean _jspx_meth_ano_005fiF_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /net/anotheria/moskito/webui/dashboards/jsp/Dashboard.jsp(29,8) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_ano_005fiF_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.selectedDashboard != null}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      ...
      if (_jspx_eval_ano_005fiF_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                    <a href=\"#DeleteDashboard\" data-toggle=\"modal\" data-target=\"#DeleteDashboard\" title=\"Delete Dashboard\">Delete this Dashboard</a>\n");
          out.write("                </div>\n");
          out.write("            </div>\n");
          out.write("        ");
